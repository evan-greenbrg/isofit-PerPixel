...
def run_inversion(self, input_data):
    try:
        ...
        result = inversion(
            ...
            np.array(input_data["longitude"]),
            np.array(input_data["latitude"]),
            np.array(input_data["elevation"]),
            np.array(input_data["path_length"]),
            np.array(input_data["sensor_azimuth"]),
            np.array(input_data["sensor_zenith"]),
            np.array(input_data["sun_azimuth"]),
            np.array(input_data["sun_zenith"]),
            np.array(input_data["solar_phase"]),
            np.array(input_data["slope"]),
            np.array(input_data["aspect"]),
            np.array(input_data["cos_i"]),
            np.array(input_data["utc_time"]),
